...
import {
  Container,
  LikeContainer,
  ConatinerShowComments,
  ContainerCommentsAndUsers,
    ...
    <Container $showComments={showComments}>
      ...
      <div className="container-comments-scrollab">
        ...
        >
          ...
          Click na seta ou aqui para ver comentários
        </button>
      </div>
      <CommentsAndUsers
  ...
  return (
    <>
      <ContainerCommentsAndUsers
        ...
        onClick={() => maxwidth1000 && setShowComments(false)}
      >
        <div
          className="container-fixed-comments"
          data-show-comments={showComments}
        ...
        >
          ...
          <div className="comments-pin" id="scroll-comments-and-users">
            {allCommentsInPin ? (
              <InfiniteScroll
...
function AddCommentsLocal({
  ...
  const [isLikePin, setIsLikePin] = useState(
    stDataPin.likes.users.includes(userId)
  );
  ...
  return (
    <ContainerAddComments data-fixed={fixedAddComments ? true : false}>
      <div>
...
function ShowComments({
  ...
  }, [showComments, maxWidth1000]);

  useEffect(() => {
    handleOnResize();
  }, [handleOnResize, maxWidth1000]);
  ...
  return (
    <ConatinerShowComments $showComments={showComments}>
      <h2>Comentários</h2>
      <button
        type="button"
